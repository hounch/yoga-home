  ...
  return (
    <>
      <section className="sertificates">
        <div className=" mt-[120px] md:mx-auto ml-[1.43rem] max-w-[1200px] text-left md:text-center text-[#494542]">
          <h2 className="font-[400px] text-[42px] leading-[48px]">
            Подарочные сертификаты
          </h2>

          <div className="flex content mx-auto md:lg:max-w-[1200px] mt-[90px] justify-center">
            <Image
