    ...
    <>
      <section className="goods">
        <div className="container mx-auto max-w-full md:lg:max-w-[1200px] mt-[100px] px-4">
          <div className="flex flex-col md:flex-row items-start gap-8">
            <div className="goods-content text-left text-[#494542] flex-1">
              ...
              <ul className="lg:md:text-[22px] text-[18px] mt-[35px] font-[400px] leading-[50px] max-w-[463px]">
                ...
                <li className="pl-[20px] pt-[6px] h-[53px] align-middle">
                  Фотозона
                </li>
              </ul>
            </div>
            <div className="lg:md:block flex-shrink-0 hidden">
              <Image
                src={"/studio9.jpg"}
                width={401}
                height={463}
        ...
        <div className="container mx-auto max-w-full md:lg:max-w-[1200px] text-center text-[#494542] pt-[89px] px-4">
          <div className="lg:md:flex hidden flex-col md:flex-row justify-center gap-4 mb-[120px] max-w-full">
            <Image
              src={"/studio10.jpg"}
              width={562}
              height={374}
          ...
          <div
            className="carousel block md:hidden lg:hidden pt-[107px] mb-[5.71rem]"
            id="events"
          >
            <Carousel type="Card7" data={eventsData} />
          </div>
          <h2 className="font-[400px] text-[42px] leading-[114%] lg:md:text-center text-left">
            Открывайте новое для себя
            <br />
            на мероприятиях в Йога Хом
          </h2>
          <p className="text-[22px] mt-[35px] font-[400px] leading-[30px] lg:md:text-center text-left">
          ...
          <Button
            variant="solid"
            className="lg:md:flex hidden h-[40px] w-[223px] justify-center items-center mt-[40px] mx-auto"
          >
